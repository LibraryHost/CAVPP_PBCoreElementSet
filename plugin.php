...
class PBCorePlugin extends Omeka_Plugin_Abstract
{
    ...
    public function hookInstall()
    {
        ...
        if ($this->_getElementSet(self::ELEMENT_SET_NAME)) {
            throw new Omeka_Plugin_Exception('An element set by the name "' . self::ELEMENT_SET_NAME . '" already exists. You must delete that element set to install this plugin.');
        }
    ...
    public function filterDefineActionContexts($contexts, $controller)
    {
